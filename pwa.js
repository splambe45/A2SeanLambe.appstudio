...
const cacheName = 'A2AndrewGoehl-2021-09-20 00:46:55.291156'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2AndrewGoehl'.length) === 'A2AndrewGoehl') {
